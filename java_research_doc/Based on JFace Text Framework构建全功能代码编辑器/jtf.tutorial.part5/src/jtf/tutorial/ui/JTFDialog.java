...
public class JTFDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		// create viewer
		ExprViewer viewer = new ExprViewer(control, new VerticalRuler(12), SWT.V_SCROLL | SWT.H_SCROLL | SWT.BORDER | SWT.MULTI
				| SWT.FULL_SELECTION);
		...
		viewer.setDocument(doc, new AnnotationModel());
